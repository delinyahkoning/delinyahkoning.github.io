// Liquify + Prism offsets using a canvas as normal map
...
const CFG = window.APP?.hero || {};
const MAX_IMPRINTS = CFG.MAX_IMPRINTS ?? 150;
const LIFE         = CFG.LIFE ?? 9000;
const BASE         = CFG.BASE ?? 128;
const BASE_RADIUS  = CFG.BASE_RADIUS ?? 110;
const STRETCH      = CFG.STRETCH ?? 3.0;
const TWIRL        = CFG.TWIRL ?? 1.8;
